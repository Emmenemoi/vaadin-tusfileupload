package com.asaoweb.vaadin.tusfileupload.exceptions;
...
public class TusException extends Exception
{
	...
	public static class ConfigError extends TusException
	{
		public ConfigError(String problem) 
		{
			super(HttpServletResponse.SC_PRECONDITION_FAILED, "unsupported configuration: "+problem);
		}
	}
